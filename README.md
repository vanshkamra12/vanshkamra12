...
| **[FraudShield-MLOps](https://github.com/vanshkamra12/fraudshield)** | **Real-time Fraud Detection Pipeline.** End-to-end MLOps system processing streaming transactions via Kafka. Features a LightGBM scoring service (<10ms latency), automated weekly retraining via Airflow, data drift detection with Evidently AI, and live monitoring via Prometheus/Grafana. | `Kafka`, `FastAPI`, `Airflow`, `Docker` |
